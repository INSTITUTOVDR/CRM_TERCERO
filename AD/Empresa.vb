...
Public Class Empresa
    ...
    End Function
    Public Sub Agregar(RazonSocial As String, Fantasia As String, NroCuit As String, IdLocalidad As Integer, Domicilio As String, Lat As String, Lng As String, rutaAbsoluta As String, EmpresaTipo As Integer, Observaciones As String, Prioridad As Integer, FechaInicioActividad As Date, Estado As Integer)
