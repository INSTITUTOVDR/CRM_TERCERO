<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="template-ABM.aspx.vb" Inherits="CRM_TERCERO.template_ABM" %>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Título ABM</h4>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="textBox1" class="form-control" placeholder="Text Box 1" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="textBox2">Text Box 2</label>
                                                                <input type="text" id="textBox2" class="form-control" placeholder="Text Box 2" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="textBox3" class="form-control" placeholder="Text Box 3" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="textBox4">Text Box 4</label>
                                                                <input type="text" id="textBox4" class="form-control" placeholder="Text Box 4" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="textBox5">Text Box 5</label>
                                                                <input type="text" id="textBox5" class="form-control" placeholder="Text Box 5" />
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <hr />
                                                        ...
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="textBox6">Text Box 6</label>
                                                                <input type="text" id="textBox6" class="form-control" placeholder="Text Box 6" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="textBox7">Text Box 7</label>
                                                                <input type="text" id="textBox7" class="form-control" placeholder="Text Box 7" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                    ...
                                    <table class="table table-hover" id="tabla1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Columna 6</th>
                                                <th scope="col">Columna 7</th>
                                                <th scope="col">Columna 8</th>
                                                <th scope="col">Columna 9</th>
                                                <th scope="col">Columna 10</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
