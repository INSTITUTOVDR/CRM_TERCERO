...
(function (factory) {
	...
	$.extend(true, DataTable.defaults, {
		dom:
			...
			"<'row mb-3'<'col-sm-12 table-responsive'tr>>" +
				...
				if (Array.isArray(button)) {
					...
					switch (button) {
						...
						case 'previous':
							...
							btnDisplay = `<dt class="the-icon"><span class="fa-fw select-all fas"></span></dt>`;
							btnClass = button + (page > 0 ?
								'' : ' disabled');
							break;
